...
// -------------------------- OTHER METHODS --------------------------
    ...
    public boolean doPrintToPdf(Node rootPane, List<List> list, File saveLoc, Orientation orientation) {
        try {
            if (saveLoc == null) {
                return false;
            }
            ...
            AlertMaker.showErrorMessage(rootPane, "Error occurred during PDF export", ex.getMessage());
        }
        return false;
    }
